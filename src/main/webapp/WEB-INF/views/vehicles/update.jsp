...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ${vehicule.getModele()} ${vehicule.getConstructeur()}
            </h1>
        </section>
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        value="${vehicule.getConstructeur()}">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nb_places" name="nb_places" value="${vehicule.getNbPlaces()}">
                                    </div>
                                </div>
                                <!--
                                <div class="form-group">
